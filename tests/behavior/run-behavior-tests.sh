...
TS_NODE_PROJECT=tsconfig.app.json API_URL=http://localhost:3003 API_CACHE_DISABLED=true MC_FRONTEND_PORT=4003 node -r ts-node/register "$SCRIPT_PATH"/../../src/server.ts &
