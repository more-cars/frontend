...
import {displayNode} from "../../../../src/controllers/node-types/racing-series/displayNode"
...
describe('Racing Series', () => {
    ...
    test('Show Node Detail Page', async () => {
        vi.mock("../../../../src/controllers/node-types/racing-series/displayNode", () => ({
            displayNode: vi.fn((req, res) => res.status(200).end())
        }))

        await supertestGet('/racing-series/999')
