...
describe('Collect connected IMAGES for the PROGRAMME EPISODE detail page', () => {
    ...
    test('when there are IMAGES connected', async () => {
        vi.spyOn(ProgrammeEpisodeDataFacade, 'getConnectedImageNodes').mockResolvedValue([
            {id: 12222228, name: "dummy 2", partner_node: FakeImage.data} as unknown as ProgrammeEpisodeHasImageRelationship,
            {id: 13333338, name: "dummy 3", partner_node: FakeImage.data} as unknown as ProgrammeEpisodeHasImageRelationship,
        ])
