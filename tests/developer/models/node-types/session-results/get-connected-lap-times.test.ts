...
import {SessionResultHasLapTimeRelationship} from "../../../../../src/data/node-types/session-results/types/SessionResultHasLapTimeRelationship"
...
describe('Collect connected LAP TIMES for the SESSION RESULT detail page', () => {
    ...
    test('when there are LAP TIMES connected', async () => {
        vi.spyOn(SessionResultDataFacade, 'getConnectedLapTimeNodes').mockResolvedValue([
            {id: 12222228, driver_name: "dummy 2", partner_node: FakeLapTime.data} as unknown as SessionResultHasLapTimeRelationship,
            {id: 13333338, driver_name: "dummy 3", partner_node: FakeLapTime.data} as unknown as SessionResultHasLapTimeRelationship,
        ])
