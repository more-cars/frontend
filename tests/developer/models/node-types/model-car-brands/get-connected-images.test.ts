...
describe('Collect connected IMAGES for the MODEL CAR BRAND detail page', () => {
    ...
    test('when there are IMAGES connected', async () => {
        vi.spyOn(ModelCarBrandDataFacade, 'getConnectedImageNodes').mockResolvedValue([
            {id: 12222228, name: "dummy 2", partner_node: FakeImage.data} as unknown as ModelCarBrandHasImageRelationship,
            {id: 13333338, name: "dummy 3", partner_node: FakeImage.data} as unknown as ModelCarBrandHasImageRelationship,
        ])
