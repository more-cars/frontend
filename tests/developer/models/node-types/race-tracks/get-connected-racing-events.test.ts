...
import {
    RaceTrackHostedRacingEventRelationship
} from "../../../../../src/data/node-types/race-tracks/types/RaceTrackHostedRacingEventRelationship"
        ...
        vi.spyOn(RaceTrackDataFacade, 'getConnectedRacingEventNodes').mockResolvedValue([
            {
                id: 2,
                name: "dummy 2",
                partner_node: {name: "dummy"}
            } as unknown as RaceTrackHostedRacingEventRelationship,
            {
                id: 3,
                name: "dummy 3",
                partner_node: {name: "dummy"}
