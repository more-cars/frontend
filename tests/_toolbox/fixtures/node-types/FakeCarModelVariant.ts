...
export const FakeCarModelVariant = {
    model: {
        ...
        fields: {
            ...
            weight_norm: faker.helpers.arrayElement(['DIN', 'EG']),
            max_power: faker.number.int({min: 100, max: 1000}),
            max_power_unit: faker.helpers.arrayElement(['PS', 'kW']),
            max_power_norm: faker.helpers.arrayElement(['DIN', 'SAE']),
            ...
            air_induction: faker.helpers.arrayElement(['turbocharged', 'supercharged']),
