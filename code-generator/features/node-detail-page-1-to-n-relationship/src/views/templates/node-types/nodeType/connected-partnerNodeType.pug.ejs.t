...
- thumbnails = relationships.<%= h.changeCase.kebab(h.inflection.pluralize(partnerNodeType)) %>.thumbnails
- nodeProperties = relationships.<%= h.changeCase.kebab(h.inflection.pluralize(partnerNodeType)) %>.node_properties
